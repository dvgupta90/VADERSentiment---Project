...
def users():
    ...
    rest1 = Restaurant_details(biz_id = "abc", restaurant_name = "taj1", category = "fb", price = "$")
    rest2 = Restaurant_details(biz_id = "def",restaurant_name = "taj2", category = "fbfv", price = "$$")
    rest3 = Restaurant_details(biz_id = "ghi",restaurant_name = "taj3", category = "fbnhm", price = "$")
